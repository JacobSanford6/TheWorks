...
public class ClothingController extends BaseController {
	...
	private List<String>		clothingSizes;
	...
	public ClothingController(	ProductRepo productRepo,
		...
		clothingTypes = List.of("Top", "Bottom", "Top and Bottom");
		clothingMaterials = List.of("Denim", "Cotton", "Other");
		clothingColors = List.of("White", "Black", "Grey", "Red", "Blue", "Orange", "Yellow", "Green", "Tie Dye");
		clothingSizes = List.of("XXXS", "XXS", "XS", "S", "M", "L", "XL", "XXL", "XXXL", "XXXXL");
	}
